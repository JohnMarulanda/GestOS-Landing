...
const SimonSaysGame = forwardRef<SimonSaysGameRef, SimonSaysGameProps>(
  ({ isActive, onToggle }, ref) => {
    ...
    // Emojis y colores para cada gesto con traducciones
      ...
      return (
        ...
        >
          ...
          <h3 className="text-xl font-bold text-white mb-2">
            {t('productShowcase.demos.simon.title')}
          </h3>
          ...
          >
            ...
            {t('productShowcase.demos.simon.ui.activateGame')}
          </button>
        </motion.div>
      )
    }
        ...
        <div className="relative aspect-video bg-gray-900 overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col justify-between p-4 bg-black/40">
            ...
            <div className="flex items-center justify-between">
              <div className="bg-black/70 backdrop-blur-md rounded-xl p-3 text-white">
                ...
                <div className="grid grid-cols-4 gap-2 text-center text-xs">
                  <div className="bg-green-500/20 rounded p-1">
                    ...
                    <div className="text-[8px] text-white/60">{t('productShowcase.demos.simon.ui.level')}</div>
                  </div>
                  <div className="bg-yellow-500/20 rounded p-1">
                    <div className="font-bold text-yellow-400">{stats.bestLevel}</div>
                    <div className="text-[8px] text-white/60">{t('productShowcase.demos.simon.ui.best')}</div>
                  </div>
                  <div className="bg-blue-500/20 rounded p-1">
                    <div className="font-bold text-blue-400">{stats.successStreak}</div>
                    <div className="text-[8px] text-white/60">{t('productShowcase.demos.simon.ui.streak')}</div>
                  </div>
                  <div className="bg-purple-500/20 rounded p-1">
                    <div className="font-bold text-purple-400">{stats.bestStreak}</div>
                    <div className="text-[8px] text-white/60">{t('productShowcase.demos.simon.ui.record')}</div>
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                title={t('productShowcase.demos.simon.ui.closeGame')}
              >
                ✕
              </button>
            </div>
              ...
              <AnimatePresence mode="wait">
                {gameState === 'waiting' && (
                  ...
                  >
                    ...
                    <p className="text-white/80 mb-4">{t('productShowcase.demos.simon.ui.waiting')}</p>
                    <p className="text-white/60 text-sm mb-4">
                      {t('productShowcase.demos.simon.ui.levelText', { level: stats.currentLevel, nextLevel: stats.currentLevel + 2 })}
                    </p>
                    <button
                      onClick={startGame}
                ...
                {gameState === 'showing' && (
                  ...
                  >
                    <div className="text-xl text-white/80 mb-4">
                      {t('productShowcase.demos.simon.ui.remember')}
                    </div>
                ...
                {gameState === 'playing' && (
                  ...
                  >
                    ...
                    <p className="text-white font-bold text-lg mb-2">{t('productShowcase.demos.simon.ui.yourTurn')}</p>
                ...
                {gameState === 'success' && (
                  ...
                  >
                    <div className="text-6xl mb-4">🎉</div>
                    <p className="text-green-400 font-bold text-xl mb-2">{t('productShowcase.demos.simon.ui.perfect')}</p>
                    <p className="text-white/80 text-sm mb-4">
                      {t('productShowcase.demos.simon.ui.levelUp', { level: stats.currentLevel + 1 })}
                    </p>
                    <div className="flex items-center justify-center gap-2">
                      <Zap className="w-4 h-4 text-yellow-400" />
                      <span className="text-yellow-400 text-sm">
                        {t('productShowcase.demos.simon.ui.streakText', { streak: stats.successStreak })}
                      </span>
                    </div>
                  </motion.div>
                )}
                ...
                {gameState === 'failure' && (
                  ...
                  >
                    <div className="text-6xl mb-4">💥</div>
                    <p className="text-red-400 font-bold text-xl mb-2">{t('productShowcase.demos.simon.ui.wrong')}</p>
                    <p className="text-white/80 text-sm mb-4">
                      {t('productShowcase.demos.simon.ui.tryAgain')}
                    </p>
                    
                    {/* Mostrar la secuencia correcta */}
                    <div className="mb-4">
                      <p className="text-white/60 text-xs mb-2">{t('productShowcase.demos.simon.ui.correctSequence')}</p>
            ...
            {isStreaming && isRecognizing && gameState === 'waiting' && (
              <motion.div
                ...
                transition={{ delay: 1 }}
              >
                <p className="font-medium mb-1">{t('productShowcase.demos.simon.ui.gesturesAvailable')}</p>
          ...
          {loading && (
            ...
            >
              <div className="flex flex-col items-center text-white max-w-sm text-center">
                ...
                <p className="text-sm mb-2">{t('productShowcase.demos.simon.ui.initializing')}</p>
                <p className="text-xs text-gray-300">
                  {t('productShowcase.demos.simon.ui.loadingRecognition')}
                </p>
              </div>
            </motion.div>
          )}
            ...
            {displayError && (
              ...
              >
                <div className="text-center text-white">
                  ...
                  >
                    {t('productShowcase.demos.simon.ui.retry')}
                  </button>
                </div>
              </motion.div>
            )}
          ...
          {isStreaming && isRecognizing && (
            ...
            >
              ...
              <span className="text-white text-xs font-medium">{t('productShowcase.demos.simon.ui.memory')}</span>
            </motion.div>
          )}
        </div>
      </motion.div>
